...
echo -e "\033[96;1m============================\033[0m"
echo -e "\033[91;1m Note. contoh Subdomain :\033[0m \033[93mganteng \033[0m"
echo -e " "
...
dns=${sub}.ramsvpn.my.id
CF_KEY=d4ddf18e95d7d47a3c13bb7047ce446b
CF_ID=tuyulgames1001@gmail.com
set -euo pipefail
